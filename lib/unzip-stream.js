...
UnzipStream.prototype._readExtraFields = function (data) {
    console.log("THIS HAS BEEN EDITED BY leo@enhatch.com &&&&&")
    var extra = {};
    ...
    while (index + 4 <= data.length) {
        ...
        // FIX: Check if extraSize extends beyond buffer
        if (index + vars.extraSize > data.length) {
            // Malformed extra field - stop parsing
            break;
        }
